...
//Get highest id from drivetrains table (highest id equals number of rows)
$result1 = $conn->query("SELECT id FROM drivetrains;");
$id = mysqli_num_rows($result1)+1;//Add one since id of new part will be the largest id already in table + 1

//Put new drivetrain into SQL table
$result2 = $conn->query("INSERT INTO drivetrains VALUES (" . $id . ", \"" . $brand . "\", \"" . $model . "\", " . $year . ", \"" . $manufLink . "\", \"" . $imgLink . "\");");
if(!$result2){failure();}
else{success();}
